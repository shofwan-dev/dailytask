    ...
    <div class="max-w-3xl mx-auto">
        ...
        <div class="mb-8 animate-fade-in">
            <div class="flex items-center space-x-3 mb-2">
                ...
                <h1 class="text-3xl md:text-4xl font-bold text-white">Edit Project</h1>
            </div>
            <p class="text-purple-200">Update informasi project</p>
        </div>
            ...
            <form action="{{ route('projects.update', $project) }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <textarea id="description" 
                              ...
                              placeholder="Deskripsi project (opsional)">{{ old('description', $project->description) }}</textarea>
                    @error('description')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
